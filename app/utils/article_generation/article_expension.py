...
You will generate an new article based on the previous document generated by AI.
...
3. Try to expand the document as long as possible.
4. Ouput in **Chinese** language, **do not** speak English.
"""

def expand_doc_generate(task: "Task", *args):
  if task.user_input:
